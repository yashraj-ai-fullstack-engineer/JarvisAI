...
def route_request(query: str, connected_plugin_domains: Iterable[str] = ()) -> RouteDecision:
    ...
    if re.search(r"\b(?:calendar|meeting|appointment|event|availability|free time|busy)\b", text):
